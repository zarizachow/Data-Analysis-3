...
This technical report details the methodology, modeling choices, and evaluation results for predicting fast-growing firms using the Bisnode panel data (2010-2015). The code and full notebooks are available in the associated GitHub repository: \url{https://github.com/zarizachow/Data-Analysis-3/tree/main}.
...
\subsection{Target Definition \& Rationale}
